...
function Funtionally() {
    ...
    md:h-[40vh] lg:h-[110vh]
     justify-center mx-auto sm:p-15 md:p-20 lg:p-50 border-2 border-gray-200 shadow-sm" style={{borderRadius: "90px 90px 0px 0px", background: `url(${File})`,backgroundSize: "100%", backgroundRepeat: "no-repeat"}} >
