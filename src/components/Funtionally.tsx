...
function Funtionally() {
    ...
    md:h-[40vh] lg:h-[130vh]
     justify-center mx-auto sm:p-15 md:p-20 lg:p-50 border-2 border-gray-200 shadow-sm" style={{borderRadius: "90px 90px 0px 0px", background: `url(${File})`,backgroundSize: "contain"}} >
        ...
        <p className="hidden sm:block md:hidden lg:block text-4xl font-normal text-gray-700 mx-auto lg:text-5xl mt-8 md:text-6xl w-[70vw] lg:w-[80vw] md:[85vw] bg-white rounded-xl p-3 shadow-xl">
